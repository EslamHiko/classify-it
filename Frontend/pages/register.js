        ...
        <div className="container">
            ...
            <div className="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" required onChange={this.handleChange} value={this.state.user.password} name="password" class="form-control" id="exampleInputPassword1" placeholder="Password"  />
              </div>
              <div class="form-group">
                <label for="exampleInputPassword2">Password Confirmation</label>
                <input type="password" required onChange={this.handleChange} value={this.state.user.password2} name="password2" class="form-control" id="exampleInputPassword2" placeholder="Password"  />
              </div>
              <div className="form-group">
